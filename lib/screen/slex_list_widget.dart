...
import 'package:ithildin/screen/entrydetail_screen.dart';
...
Route _detailRoute(int entryId) {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => EntryDetailScreen(entryId),
...
class _SLexListItemState extends State<SLexListItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          print('tapped on Entry:' + widget.entryId.toString());
          Navigator.of(context).push(_detailRoute(widget.entryId));
        });
      },
      child: Container(
